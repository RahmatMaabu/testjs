...
import { BiChevronDown, BiChevronLeft, BiGroup, BiPencil, BiSolidGraduation } from 'react-icons/bi';
    ...
    <div className="flex flex-col items-center px-4 py-3">
      <button onClick={ShowMenu} className="flex flex-row items-center justify-between w-full text-gray-300  hover:text-zinc-700">
        <div className="flex  items-center justify-center gap-4">
          <BiSolidGraduation size={25} />
          <h2 className="text-sm">Akademik</h2>
        </div>
